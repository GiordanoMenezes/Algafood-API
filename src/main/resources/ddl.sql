...
create table item_pedido (id bigint not null auto_increment, observacao varchar(255), preco_total decimal(11,2), preco_unitario decimal(11,2), quantidade integer not null, pedido_id bigint not null, produto_id bigint, primary key (id)) engine=InnoDB
create table pedido (id bigint not null auto_increment, codigo varchar(10) not null, data_cancelamento datetime, data_confirmacao datetime, data_criacao datetime not null, data_entrega datetime, endereco_bairro varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), endereco_logradouro varchar(255), endereco_numero varchar(255), status varchar(255), sub_total decimal(19,2) not null, taxa_frete decimal(19,2) not null, total decimal(19,2) not null, cliente_id bigint not null, endereco_cidade_id bigint, formapagto_id bigint not null, restaurante_id bigint not null, primary key (id)) engine=InnoDB
...
alter table pedido add constraint UK_p6h3xykm0g7lqxwbo6suwqujj unique (codigo)
...
alter table pedido add constraint FKn2rq2hnonn9567d3dsqlogspj foreign key (formapagto_id) references forma_pagamento (id)
